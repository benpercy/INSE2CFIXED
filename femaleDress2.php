...
<table class="images">
      <tr>
	<td>
	<img src="images/Female dress2.jpg" alt="Cardigan1" style="width:304px;height:228px;"/><br>
  Stripped dress, pink, white, blue
	</td>
	</tr>
</table>
...
<article>
  ...
  <form action="includes/purchase.inc.php" method="POST">
    <input type="text" name="price" value="10.00" readonly><br>
